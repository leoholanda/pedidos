...
@Named
@ViewScoped
public class PesquisaPedidoAutorizadoController implements Serializable {
	...
	public void init() {
		pedido = new Pedido();
		pedidos = pedidoService.findPedidoByStatusOrderByUnidade(Status.AUTORIZADO);
	}
	 ...
	 * @return
	 */
	public Long getContaPedidosAutorizados() {
		return pedidoService.countPedidosByStatus(Status.AUTORIZADO);
	}
