...
public class PesquisaPedidoController implements Serializable {
	...
	public Long getContaTodos() {
		return pedidoService.countAll();
	}
	
	public List<String> getListaStatus() {
		return Arrays.asList(Status.ABERTO.getDescricao(), Status.AUTORIZADO.getDescricao(), Status.ENTREGUE.getDescricao(), Status.CANCELADO.getDescricao());
	}
	...
	public String toString() {
		return pedido.getId() + " | " + pedido.getUnidade().getCodigoCompleto();
	}
